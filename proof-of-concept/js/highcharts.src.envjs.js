...
var doc = document,
	...
	hasSVG = (!!doc.createElementNS && !!doc.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect) || typeof(Envjs) != 'undefined',
				...
				if (span !== '' || spans.length === 1) {
					...
					if (!spanNo) {						
						if (lineNo) {
							...
							lineHeight = win[GET_COMPUTED_STYLE] && win[GET_COMPUTED_STYLE](lastLine, null) &&
